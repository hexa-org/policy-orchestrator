...
func (n *NoopProvider) GetPolicyInfo(_ orchestrator.IntegrationInfo, _ orchestrator.ApplicationInfo) ([]policysupport.PolicyInfo, error) {
	return []policysupport.PolicyInfo{
		{policysupport.MetaInfo{Version: "aVersion"}, []policysupport.ActionInfo{{"anAction"}}, policysupport.SubjectInfo{AuthenticatedUsers: []string{"aUser"}}, policysupport.ObjectInfo{Resources: []string{"/"}}},
		{policysupport.MetaInfo{Version: "aVersion"}, []policysupport.ActionInfo{{"anotherAction"}}, policysupport.SubjectInfo{AuthenticatedUsers: []string{"anotherUser"}}, policysupport.ObjectInfo{Resources: []string{"/"}}},
	}, n.Err
}
