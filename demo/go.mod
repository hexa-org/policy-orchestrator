...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/attributevalue v1.14.6 // indirect
	...
	github.com/aws/aws-sdk-go-v2/service/verifiedpermissions v1.17.0 // indirect
