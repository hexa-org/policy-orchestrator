...
require (
	...
	github.com/hexa-org/policy-mapper/mapper/formats/awsCedar v0.0.0-20231130234015-58d68aeab5af
	github.com/hexa-org/policy-mapper/mapper/formats/gcpBind v0.0.0-20231130234015-58d68aeab5af
)
